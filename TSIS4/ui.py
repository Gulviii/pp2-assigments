...
class UI:
    ...
    def show_menu(self):
        """Басты мәзірді көрсету"""
        self.screen.fill((220, 220, 220)) # Сұр түсті фон
    ...
    def show_leaderboard(self, data):
        """Лидерлер кестесін көрсету"""
        self.screen.fill((255, 255, 255)) # Ақ түсті фон
