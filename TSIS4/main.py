...
pygame.mixer.init()
# загрузка звуков
eat_sound = pygame.mixer.Sound("TSIS4/assets/sounds/free-sound-1674743464.mp3")
gameover_sound = pygame.mixer.Sound("TSIS4/assets/sounds/free-sound-1675012530.mp3")
pygame.mixer.music.load("TSIS4/assets/sounds/super-mario-bros_2.mp3")
...
background_img = pygame.image.load("TSIS4/assets/images/background.png")
snake_img = load_scaled("TSIS4/assets/images/snake.png")
food_img = load_scaled("TSIS4/assets/images/food.png")
poison_img = load_scaled("TSIS4/assets/images/poison.png")
