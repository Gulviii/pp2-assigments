...
playlist = [os.path.join(r"C:\Users\Lenovo\Desktop\g_abdigapbar\pp2-assigments\prac9\music\tracks", f)
            for f in os.listdir(r"C:\Users\Lenovo\Desktop\g_abdigapbar\pp2-assigments\prac9\music\tracks")
